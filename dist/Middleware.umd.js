(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["Middleware"] = factory();
	else
		root["Middleware"] = factory();
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "registrar", function() { return /* reexport */ registrar; });
__webpack_require__.d(__webpack_exports__, "alias", function() { return /* reexport */ alias; });
...
__webpack_require__.d(__webpack_exports__, "MiddlewareRoute", function() { return /* reexport */ MiddlewareRoute_Route; });
...
var DEFAULT_MESSAGE = 'Middleware failed to validate.';

var MiddlewareError_MiddlewareError = /*#__PURE__*/function (_Error) {
  _inherits(MiddlewareError, _Error);

  var _super = _createSuper(MiddlewareError);
  ...
  function MiddlewareError(middleware) {
    ...
    _classCallCheck(this, MiddlewareError);
    ...
    var to = route.to,
        from = route.from,
        next = route.next;
    _this = _super.call(this, msg || DEFAULT_MESSAGE);
    _this.to = to;
    _this.from = from;
    _this.next = next;
    _this.response = response;
    _this.middleware = middleware;
    Error.captureStackTrace(_assertThisInitialized(_this), MiddlewareError);
    return _this;
  }
...
var Middleware_Middleware = /*#__PURE__*/function () {
  function Middleware(validator, options) {
  ...
  _createClass(Middleware, [{
    ...
    set: function set(validator) {
      var resolved = this.resolveAlias(validator) || this.resolveGroup(validator) || validator;

      if (typeof resolved !== 'function') {
        throw new Error('The middleware validator must a `Function`.');
      }
    ...
    key: "resolveAlias",
    value: function resolveAlias(value) {
      if (!this.registrar) {
        return;
      }

      var match = this.registrar.registry.alias.get(value);
      return match && match.validator;
    }
  }, {
    key: "resolveGroup",
    value: function resolveGroup(value) {
      if (!this.registrar) {
        return;
      }

      var match = this.registrar.registry.group.get(value);
      return match && match.validator;
    }
  }, {
    key: "validate",
    ...
    value: function make(subject) {
      ...
      return construct_construct(this, [subject].concat(args));
    }
  }]);
...
// CONCATENATED MODULE: ./src/Iterator.js
...
var Iterator_Iterator = /*#__PURE__*/function (_Symbol$iterator) {
  ...
  _createClass(Iterator, [{
    ...
    key: "indexOf",
    value: function indexOf(middleware) {
      return this.items.indexOf(middleware);
    }
  }, {
    key: "contains",
    value: function contains(middleware) {
    ...
    key: "prioritize",
    value: function prioritize(priority) {
    ...
    value: function push() {
      ...
      (_this$items = this.items).push.apply(_this$items, _toConsumableArray(args.map(function (arg) {
        return _this.cast(arg);
      })));
    ...
    value: function splice(start, end) {
      ...
      (_this$items2 = this.items).splice.apply(_this$items2, [start, end].concat(_toConsumableArray(args.map(function (arg) {
        return _this2.cast(arg);
      }))));
    ...
    value: function unshift() {
      ...
      (_this$items3 = this.items).unshift.apply(_this$items3, _toConsumableArray(args.map(function (arg) {
        return _this3.cast(arg);
      })));
    ...
    value: function remove(index) {
      var matching = this.indexOf(index);
    ...
    key: "validate",
    value: function () {
      var _validate = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(to, from, next) {
...
Object.getOwnPropertyNames(Array.prototype).filter(function (prop) {
  ...
  return !Iterator_Iterator.prototype[prop];
}).map(function (prop) {
  Iterator_Iterator.prototype[prop] = function () {
    var _this$items4;

    return (_this$items4 = this.items)[prop].apply(_this$items4, arguments);
  };
});
...
var MiddlewareIterator_MiddlewareIterator = /*#__PURE__*/function (_Iterator) {
  _inherits(MiddlewareIterator, _Iterator);

  var _super = _createSuper(MiddlewareIterator);

  function MiddlewareIterator(items, options) {
    _classCallCheck(this, MiddlewareIterator);

    return _super.call(this, items, Object.assign({
      cast: function cast(value) {
        return Middleware_Middleware.make(value, {
...
function src_get_get(object, path, defaultValue) {
...
function property_property(path) {
    return object => {
        return src_get_get(object, path);
    };
}
...
function matchesProperty(path, value) {
    return subject => {
        return src_get_get(subject, path) === value;
    };
}
...
var MATCH_PATTERN = /^on_?([A-Z]?[a-z]+)?/;
function qualifyCallbackFunction(key) {
  return camelCase(key.match(MATCH_PATTERN) ? key : "on_".concat(key));
}
function qualifyCallbackKey(key) {
  var matches = key.match(MATCH_PATTERN);
...
var EventEmitter_EventEmitter = /*#__PURE__*/function () {
  ...
  _createClass(EventEmitter, [{
    ...
    value: function off(key, fn) {
      key = qualifyCallbackKey(key);
      var index = this.callbacks[key] && this.callbacks[key].indexOf(fn);
    ...
    value: function emit(key) {
      ...
      if (this.callbacks[key]) {
        [].concat(this.callbacks[key]).forEach(function (fn) {
...
var MiddlewareRoute_Route = /*#__PURE__*/function (_EventEmitter) {
  ...
  function Route(route, options) {
    ...
    _this.registrar = _this.options.registrar;
    _this.middlewares = [];
    ...
    _this.intializeBeforeEnter(route);

    _this.initializeRoute(route);
  ...
  _createClass(Route, [{
    ...
    key: "middlewaresWithGlobal",
    get: function get() {
      var middlewares = [].concat(_toConsumableArray(this.$middlewares), _toConsumableArray(this.registrar ? this.registrar.registry.middleware : []));
      var iterator = new MiddlewareIterator_MiddlewareIterator(middlewares, {
        registrar: this.registrar
      });
      var prioritized = iterator.prioritize(Array.from(this.registrar ? this.registrar.registry.priority : []));
      return new MiddlewareIterator_MiddlewareIterator(prioritized, {
        registrar: this.registrar
      });
    }
  }, {
    ...
    value: function emit() {
      ...
      if (this.registrar) {
        ...
        (_this$registrar = this.registrar).emit.apply(_this$registrar, args);
      }

      return (_get2 = get_get(_getPrototypeOf(Route.prototype), "emit", this)).call.apply(_get2, [this].concat(args));
    }
  }, {
    key: "middleware",
    value: function middleware() {
      ...
      values.forEach(function (value) {
        ...
        value.forEach(function (value) {
          return _this3.middlewares.push(value);
        });
      });
      return this;
    }
...
// CONCATENATED MODULE: ./src/MiddlewareMap.js
...
var MiddlewareMap_MiddlewareMap = /*#__PURE__*/function (_Map) {
  _inherits(MiddlewareMap, _Map);

  var _super = _createSuper(MiddlewareMap);

  function MiddlewareMap(iterable, options) {
    var _this;

    _classCallCheck(this, MiddlewareMap);
    ...
    iterable.forEach(function (_ref) {
  ...
  _createClass(MiddlewareMap, [{
    key: "set",
    value: function set(key, value) {
      value = this.options.cast ? this.options.cast(value) : value;
      return get_get(_getPrototypeOf(MiddlewareMap.prototype), "set", this).call(this, key, value);
    }
  }], [{
    key: "make",
    value: function make(subject) {
...
}( /*#__PURE__*/wrapNativeSuper_wrapNativeSuper(Map));


// CONCATENATED MODULE: ./src/MiddlewareIteratorMap.js
...
var MiddlewareIteratorMap_MiddlewareIteratorMap = /*#__PURE__*/function (_MiddlewareMap) {
  _inherits(MiddlewareIteratorMap, _MiddlewareMap);

  var _super = _createSuper(MiddlewareIteratorMap);

  function MiddlewareIteratorMap() {
    _classCallCheck(this, MiddlewareIteratorMap);

    return _super.apply(this, arguments);
  }

  _createClass(MiddlewareIteratorMap, [{
    key: "set",
    value: function set(key, values) {
      return get_get(_getPrototypeOf(MiddlewareIteratorMap.prototype), "set", this).call(this, key, new MiddlewareIterator_MiddlewareIterator(values, this.options));
    }
  }]);

  return MiddlewareIteratorMap;
}(MiddlewareMap_MiddlewareMap);


Object.getOwnPropertyNames(Array.prototype).filter(function (prop) {
  return typeof Array.prototype[prop] === 'function';
}).filter(function (prop) {
  return MiddlewareIteratorMap_MiddlewareIteratorMap.prototype[prop] === undefined;
}).map(function (prop) {
  MiddlewareIteratorMap_MiddlewareIteratorMap.prototype[prop] = function (key) {
    var _this$get;
    ...
    return (_this$get = this.get(key))[prop].apply(_this$get, args);
  };
});
// CONCATENATED MODULE: ./src/MiddlewareGroup.js
...
var MiddlewareGroup_MiddlewareGroup = /*#__PURE__*/function () {
  function MiddlewareGroup(middlewares, options) {
    _classCallCheck(this, MiddlewareGroup);
  ...
  _createClass(MiddlewareGroup, [{
    key: "middlewares",
    get: function get() {
      return this.$middlewares;
    },
    set: function set(value) {
      this.$middlewares = MiddlewareIterator_MiddlewareIterator.make(value, {
        registrar: this.registrar
      });
      ;
    }
    ...
    key: "validate",
    value: function validate(to, from, next) {
      return this.middlewares.validate(to, from, next).then(function () {
        return true;
      });
    }
  }], [{
...
// CONCATENATED MODULE: ./src/MiddlewareRegistry.js
...
var MiddlewareRegistry_MiddlewareRegistry = /*#__PURE__*/function (_EventEmitter) {
  _inherits(MiddlewareRegistry, _EventEmitter);

  var _super = _createSuper(MiddlewareRegistry);
  ...
  _createClass(MiddlewareRegistry, [{
    ...
    value: function reset() {
      ...
      this.defineRegistry('middleware', options.middleware || options.middlewares, MiddlewareIterator_MiddlewareIterator, {
        prioritize: this.prioritize
      });
      this.defineRegistry('group', options.group || options.groups, MiddlewareIteratorMap_MiddlewareIteratorMap, {
        cast: function cast(value) {
          return MiddlewareGroup_MiddlewareGroup.make(value);
        }
      });
      this.defineRegistry('alias', options.alias || options.aliases, MiddlewareMap_MiddlewareMap, {
        cast: function cast(value) {
          return Middleware_Middleware.make(value);
        }
      });
    ...
    key: "defineRegistry",
    value: function defineRegistry(key, value, cast) {
      for (var _len = arguments.length, args = new Array(_len > 3 ? _len - 3 : 0), _key = 3; _key < _len; _key++) {
        args[_key - 3] = arguments[_key];
      }

      this.registry[key] = construct_construct(cast, [value].concat(args));
      return this;
    }
  }, {
    key: "middleware",
    value: function middleware() {
      var _this$registry$middle;

      return (_this$registry$middle = this.registry.middleware).push.apply(_this$registry$middle, arguments);
    }
  }, {
    key: "alias",
    value: function alias() {
      var _this$registry$alias;

      return (_this$registry$alias = this.registry.alias).set.apply(_this$registry$alias, arguments);
    }
  }, {
    key: "group",
    value: function group() {
      var _this$registry$group;

      return (_this$registry$group = this.registry.group).set.apply(_this$registry$group, arguments);
    }
  }, {
    key: "priority",
    value: function priority(value) {
      return this.defineRegistry('priority', value, Iterator_Iterator);
    }
  }]);
...
var registrar = new MiddlewareRegistry_MiddlewareRegistry();
function alias() {
  return registrar.alias.apply(registrar, arguments);
}
function group() {
  return registrar.group.apply(registrar, arguments);
}
function registry_middleware() {
  return registrar.middleware.apply(registrar, arguments);
}
function registry_priority() {
  return registrar.priority.apply(registrar, arguments);
}
